...
import LeaveModal from "../NscMember/Modal/LeaveModal";
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <Typography variant="element6" color={"#565656"}>
              {sampleDownloadText}
            </Typography>
            <Button
              sx={{
            ...
            >
              <Image
                ...
                alt="excel"
              />
              <Typography variant="element5" sx={{ textTransform: "none" }}>
                {sampleDownloadBtnText}
              </Typography>
            </Button>
          </Box>
          ...
          >
            <Typography variant="sub_element1" color={color.text.black_70}>
              {attachFileText}
            </Typography>
            <ExcelUploadBox
